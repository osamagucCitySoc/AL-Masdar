...
- (void)viewDidLoad {
    ...
    NSArray* subs = [[NSUserDefaults standardUserDefaults] objectForKey:@"notifySubscriptions"];
...
- (IBAction)openSourcesView:(id)sender {
    isSelectSources = YES;
    [self performSegueWithIdentifier:@"selectSourcesSeg" sender:self];
}
