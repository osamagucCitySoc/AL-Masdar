...
#import "InfoFeedViewController.h"
...
@implementation InfoFeedViewController
{
...
-(void)setTheColor
{
    ...
    {
        [_optionsNavBar setTintColor:[UIColor whiteColor]];
        [_optionsNavBar setBarTintColor:[UIColor colorWithRed:0.0/255.0 green:106.0/255.0 blue:161.0/255.0 alpha:1.0]];
        [_optionsNavBar setBarStyle:UIBarStyleBlack];
        
        [_searchNavBar setTintColor:[UIColor whiteColor]];
        [_searchNavBar setBarTintColor:[UIColor colorWithRed:0.0/255.0 green:106.0/255.0 blue:161.0/255.0 alpha:1.0]];
        [_searchNavBar setBarStyle:UIBarStyleBlack];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [_topTitle setTitle:[[NSUserDefaults standardUserDefaults] objectForKey:@"theInfoTitle"]];
    ...
    [sources addObject:[[NSUserDefaults standardUserDefaults] objectForKey:@"subscriptionsObject"]];
}
