...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else
    {
        ...
        if([[[NSUserDefaults standardUserDefaults] objectForKey:@"subscriptions"] containsObject:dict2])
        {
            ...
            NSMutableArray* mutArray1 = [[NSMutableArray alloc]initWithArray:[[NSUserDefaults standardUserDefaults] objectForKey:@"breakingSubscriptions"] copyItems:YES];
            NSMutableArray* mutArray2 = [[NSMutableArray alloc]initWithArray:[[NSUserDefaults standardUserDefaults] objectForKey:@"notifySubscriptions"] copyItems:YES];
            
            [mutArray removeObject:dict2];
            [mutArray1 removeObject:dict2];
            [mutArray2 removeObject:dict2];
            
            [[NSUserDefaults standardUserDefaults]setObject:mutArray forKey:@"subscriptions"];
            [[NSUserDefaults standardUserDefaults]setObject:mutArray1 forKey:@"breakingSubscriptions"];
            [[NSUserDefaults standardUserDefaults]setObject:mutArray2 forKey:@"notifySubscriptions"];
        ...
        }else
        {
            ...
            [mutArray1 addObject:dict2];
            [mutArray2 addObject:dict2];
